...
//Take In From Firebase Varaibles
var game_id = "story1";   // this needs to come from firebase

var root_storage = "https://firebasestorage.googleapis.com/v0/b/capstone-website-834e7.appspot.com/o/";
...
function preloadImage (src) {
    ...
    image.src = root_storage + game_id + "%2F" + src.replace(/\//g,'%2F') + "?alt=media";
